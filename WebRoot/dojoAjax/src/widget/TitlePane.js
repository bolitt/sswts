...
}, onLabelClick:function (speed) {
	//dojo.debug("speed :"+speed+typeof(speed));
	if(speed&&(typeof(speed)=="number"))
	{
		if (this.open) {
			dojo.lfx.wipeOut(this.containerNode, speed).play();
			this.open = false;
		} else {
			dojo.lfx.wipeIn(this.containerNode, speed).play();
			this.open = true;
		}
	}
	else
