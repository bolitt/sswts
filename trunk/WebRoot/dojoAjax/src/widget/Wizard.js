...
dojo.widget.defineWidget("dojo.widget.WizardContainer", dojo.widget.LayoutContainer, {templateString:"<div class=\"WizardContainer\" dojoAttachPoint=\"wizardNode\">\n	<div class=\"WizardText\" dojoAttachPoint=\"wizardPanelContainerNode\">\n	</div>\n	<div class=\"WizardButtonHolder\" dojoAttachPoint=\"wizardControlContainerNode\">\n		<input class=\"WizardButton\" type=\"button\" dojoAttachPoint=\"previousButton\"/>\n		<input class=\"WizardButton\" type=\"button\" dojoAttachPoint=\"nextButton\"/>\n		<input class=\"WizardButton\" type=\"button\" dojoAttachPoint=\"doneButton\" style=\"display:none\"/>\n		<input class=\"WizardButton\" type=\"button\" dojoAttachPoint=\"cancelButton\"/>\n	</div>\n</div>\n", templateCssString:".WizardContainer {\n\tbackground: #d8d8d8;\n\tborder: #999999 1px solid;\n\tpadding: 2px;\n}\n\n.WizardTitle {\n\tcolor: #003366;\n\tpadding: 8px 5px 15px 2px;\n\tfont-weight: bold;\n\tfont-size: x-small;\n\tfont-style: normal;\n\tfont-family: Verdana, Arial, Helvetica;\n\ttext-align: left;\n}\n\n.WizardText {\n\tcolor: #000033;\n\tfont-weight: normal;\n\tfont-family: Verdana, Arial, Helvetica;\n\tpadding: 2 50; text-align: justify;\n}\n\n.WizardLightText {\n\tcolor: #666666;\n\tfont-weight: normal;\n\tfont-family: verdana, arial, helvetica;\n\tpadding: 2px 50px;\n\ttext-align: justify;\n}\n\n.WizardButtonHolder {\n\ttext-align: right;\n\tpadding: 10px 5px;\n}\n\n.WizardButton {\n\tcolor: #ffffff;\n\tbackground: #798EC5;\n\tfont-family: verdana, arial, helvetica, sans-serif;\n\tborder-right: #000000 1px solid;\n\tborder-bottom: #000000 1px solid;\n\tborder-left: #666666 1px solid;\n\tborder-top: #666666 1px solid;\n\tpadding-right: 4px;\n\tpadding-left: 4px;\n\ttext-decoration: none; height: 18px;\n}\n\n.WizardButton:hover {\n\tcursor: pointer;\n}\n\n.WizardButtonDisabled {\n\tcolor: #eeeeee;\n\tbackground-color: #999999;\n\tFONT-FAMILY: verdana, arial, helvetica, sans-serif;\n\tborder-right: #000000 1px solid;\n\tborder-bottom: #000000 1px solid;\n\tborder-left: #798EC5 1px solid;\n\tborder-top: #798EC5 1px solid;\n\tpadding-right: 4px;\n\tpadding-left: 4px;\n\ttext-decoration: none;\n\theight: 18px;\n}\n\n\n", templateCssPath:dojo.uri.moduleUri("dojo.widget", "templates/Wizard.css"), selected:null, nextButtonLabel:"next", previousButtonLabel:"previous", cancelButtonLabel:"cancel", doneButtonLabel:"done", cancelFunction:"", hideDisabledButtons:false, fillInTemplate:function (args, frag) {
	...
	//direction: 1 for forward(next) 0 for backward(prev)
 onSelected:function (panel, direction) {
	if (this.selected) {
		if (this.selected._checkPass(direction)) {
			this.selected.hide();
		} else {
			return;
		}
	...
	if (selectedIndex > -1) {
		...
		if (childPanels[selectedIndex + 1]) {
			//added the direction 1 for next
			this.onSelected(childPanels[selectedIndex + 1],1);
		}
	}
	this._checkButtons();
	...
	if (selectedIndex > -1) {
		var childPanels = this.getPanels();
		if (childPanels[selectedIndex - 1]) {
			//added the direction 0 for prev
			this.onSelected(childPanels[selectedIndex - 1],0);
		}
	}
	this._checkButtons();
...
dojo.widget.defineWidget("dojo.widget.WizardPane", dojo.widget.ContentPane, {canGoBack:true, nextFunction: "", prevFunction: "", passFunction:"", doneFunction:"", postMixInProperties:function (args, frag) {
	
	if (this.passFunction) {
		this.passFunction = dj_global[this.passFunction];
	}
	if (this.nextFunction) {
		this.nextFunction = dj_global[this.nextFunction];
	}
	if (this.prevFunction) {
		this.prevFunction = dj_global[this.prevFunction];
	}
...
}, _checkPass:function (direction) {
	if (direction ==1){
		//go next
		//dojo.debug("go next!!!!!!!!!");
		//alert(this.nextFunction);
		if (this.nextFunction && dojo.lang.isFunction(this.nextFunction)) {
			var failMessage = this.nextFunction();
			if (failMessage) {
				alert(failMessage);
				return false;
			}
		...
		//go prev
		if (this.prevFunction && dojo.lang.isFunction(this.prevFunction)) {
			var failMessage = this.prevFunction();
			if (failMessage) {
				alert(failMessage);
				return false;
			}
